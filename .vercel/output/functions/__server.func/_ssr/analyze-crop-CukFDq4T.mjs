...
import "node:stream";
const analyzeCrop_createServerFn_handler = createServerRpc({
  id: "e2177ba7b40042ce731ed255200098e0b0b3f59785ab99d40670f9f9b84797b9",
  name: "analyzeCrop",
  filename: "src/server/analyze-crop.ts"
}, (opts) => analyzeCrop.__executeServer(opts));
const analyzeCrop = createServerFn({
  method: "POST"
}).inputValidator((d) => d).handler(analyzeCrop_createServerFn_handler, async ({
  data
}) => {
  try {
...
export {
  analyzeCrop_createServerFn_handler
};
